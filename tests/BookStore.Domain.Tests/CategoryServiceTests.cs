...
namespace BookStore.Domain.Tests
{
    public class CategoryServiceTests
    {
        ...
        [Fact]
        public async void GetById_ShouldReturnCategory_WhenCategory_Exist()
        {
        ...
        public async void Add_ShouldNotAddCategory_WhenCategoryNameAlreadyExist()
        {
            ...
            _categoryRepositoryMock.Setup(c => c.Search(c => c.Name == category.Name)).ReturnsAsync(categoryList);
        ...
        public async void Update_ShouldUpdateCategory_WhenCategoryNameDoesNotExist()
        {
            ...
            _categoryRepositoryMock.Setup(c => c.Search(c => c.Name == category.Name && c.Id != category.Id)).ReturnsAsync(new List<Category>());
        ...
        public async void Update_ShouldNotUpdateCategory_WhenCategoryDoesNotExist()
        {
            ...
            _categoryRepositoryMock.Setup(c => c.Search(c => c.Name == category.Name && c.Id != category.Id)).ReturnsAsync(categoryList);
        ...
        [Fact]
        public async void Remove_ShouldRemoveCategory_WhenCategoryDoesNotHaveRelatedBooks()
        {
            var category = CreateCategory();

            _bookService.Setup(b => b.GetBooksByCategory(category.Id)).ReturnsAsync(new List<Book>());
        ...
        public async void Search_ShouldReturnAListOfCategory_WhenCategoriesWithSearchedNameExist()
        {
            ...
            _categoryRepositoryMock.Setup(c => c.Search(c => c.Name.Contains(categoryName))).ReturnsAsync(categoryList);
