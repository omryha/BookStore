...
export class CategoryListComponent implements OnInit {
  ...
  constructor(private router: Router, private service: CategoryService, private toastr: ToastrService, private confirmationDialogService: ConfirmationDialogService) { }
  ...
  public deleteCategory(categoryId: number) {
    this.confirmationDialogService.confirm('Attention', 'Do you really want to delete this category?').then(() =>
